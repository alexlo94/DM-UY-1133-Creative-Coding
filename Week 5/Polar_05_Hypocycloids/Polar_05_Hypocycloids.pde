/*
Polar_05_Hypocycloids.pde
Author: Alexandros Lotsos
Summary: A sketch showcasing the use of polar coordinates and parametric equations
to draw hypocycloids of varying degrees. This sketch currently keeps b = 1, try varying it to see the results!
*/


/*
DEFINITION:
The path traced out by a point P on the edge of a circle of radius b, rolling on the inside of a circle of radius a
*/
...
void draw(){
  ...
  for(float f = 0; f < tau; f += 0.01){
    ...
    //scale by 200/a to make things visible
    vertex((200/a)*x,(200/a)*y);
  }
  endShape();
  tau += 0.1; //increment tau gradually to animate the drawing
}
